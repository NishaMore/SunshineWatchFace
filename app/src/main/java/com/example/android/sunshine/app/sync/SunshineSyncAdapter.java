...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter
    ...
    private static final String LOW_TEMP_KEY = "temp_low";
    private static final String  ICON_RES_ID_KEY = "icon_res";
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        Log.i("Connected to GoogleAPI","true");
    }
    ...
    private void sendWeatherInfoToWearable() {
         /*Nisha*/
...
*/
        ...
        if (cursor.moveToFirst()) {
            ...
            Log.v("Nisha", "High = " + high);

            // Create a DataMap object and send it to the data layer
            DataMap dataMap = new DataMap();
            dataMap.putString(HIGH_TEMP_KEY, highString);
            dataMap.putString(LOW_TEMP_KEY, lowString);
            dataMap.putInt(ICON_RES_ID_KEY, id);
            dataMap.putLong("Time", System.currentTimeMillis());

            //new thread or aynsc to avoid blocking the UI
            new DataThread(WEATHER_PATH, dataMap).start();
...
/*
        ...
        if (cursor.moveToFirst()) {
            ...
            Log.v("Nisha", "Generating DataItem: " + request);
                    ...
                    .setResultCallback(new ResultCallback<DataApi.DataItemResult>() {
                        ...
                        public void onResult(DataApi.DataItemResult dataItemResult) {
                            if (!dataItemResult.getStatus().isSuccess()) {
                                Log.e("Nisha", "ERROR: failed to putDataItem, status code: "
        ...
        class DataThread extends Thread {
            ...
            DataThread(String p, DataMap data) {
                path = p;
                dataMap = data;
            }
